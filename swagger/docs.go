// Code generated by swaggo/swag at 2024-05-10 16:09:28.572429 +0800 CST m=+2.155503917. DO NOT EDIT.
...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExampleGetResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExampleGetOneResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExamplePostRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExamplePostResponse"
                        },
                        "headers": {
                            "Location": {
                                "type": "string",
    ...
    "definitions": {
        "github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExampleGetOneResponse": {
            "type": "object",
            "required": [
                "code",
                "data",
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/github_com_yituoshiniao_gin-api-http_internal_api_http_dto.UserPortraitData"
                },
                "msg": {
                    "description": "错误消息",
                    "type": "string",
        ...
        "github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExampleGetResponse": {
            "type": "object",
            "required": [
                "code",
                "data",
        ...
        "github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExamplePostRequest": {
            "type": "object",
            "required": [
                "app_id",
                "c_ver",
        ...
        "github_com_yituoshiniao_gin-api-http_internal_api_http_dto.ExamplePostResponse": {
            "type": "object",
            "required": [
                "code",
                "data",
        ...
        "github_com_yituoshiniao_gin-api-http_internal_api_http_dto.UserPortraitData": {
            "type": "object",
            "properties": {
                "country": {
                    "description": "国家",
